...
var sharedata = {
    ...
    'link':'https://iq96552156.github.io/ali201732/bililingen/index.html',//分享到群的链接
    ...
    'qlink':'https://iq96552156.github.io/ali201732/bililingen/index.html',//分享到朋友圈的链接
    ...
    'success':function(res){
        if(res == "friend"){
            friend_num++;
			$.cookie('bililingen_friend_num', friend_num); 
            if (friend_num >= 3) {
